...
<body>
	<table style="width: 100%;max-width: 500px;margin:0 auto; font-family: "Helvetica Neue",Helvetica,Arial,sans-serif; border-collapse: collapse;">
		...
		<tr>
			<td colspan="3" style="padding: 10px;">Se ha solicitado la recuperación de tu cuenta.</td>
		</tr>
		<tr>
			<td style="height: 30px" colspan="3"></td>
		</tr>
		<tr>
			<td  style="padding: 10px;">Email Ingreso Pórtate</td>
		...
		<tr>
			<td  style="padding: 10px;">Fecha Recuparación</td>
			<td  style="padding: 10px;">:</td>
